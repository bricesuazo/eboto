  ...
  beforeLoad: async ({ context, params, location }) => {
    try {
      ...
      if (err instanceof ConvexError) {
        ...
        // VOTER-publicity election opened by a signed-out viewer: send them
        // to sign-in and bring them back here once authenticated.
        if (data.code === CONVEX_ERROR_REQUIRES_AUTH) {
          throw redirect({
            to: '/sign-in',
